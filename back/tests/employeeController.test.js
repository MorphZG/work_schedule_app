...
describe('Employee Controller', () => {
  ...
  describe('createEmployee', () => {
    ...
    it('should handle validation errors', async () => {
      ...
      vi.spyOn(Employee.prototype, 'save').mockRejectedValue(new Error(errorMessage));
  ...
  describe('updateEmployee', () => {
    it('should update an existing employee', async () => {
      ...
      expect(Employee.findByIdAndUpdate).toHaveBeenCalledWith('1', mockEmployee, { new: true });
      expect(mockRes.json).toHaveBeenCalledWith(mockEmployee);
    });
  ...
  describe('deleteEmployee', () => {
    it('should delete an existing employee', async () => {
      ...
      expect(mockRes.json).toHaveBeenCalledWith({ message: 'Employee deleted successfully' });
    });
